...
const (
	TestService_SayHello_FullMethodName      = "/test.v1.TestService/SayHello"
	TestService_SayHelloAgain_FullMethodName = "/test.v1.TestService/SayHelloAgain"
)
...
func (c *testServiceClient) SayHelloAgain(ctx context.Context, in *SayHelloAgainRequest, opts ...grpc.CallOption) (*SayHelloAgainResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SayHelloAgainResponse)
	err := c.cc.Invoke(ctx, TestService_SayHelloAgain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestServiceServer) SayHelloAgain(context.Context, *SayHelloAgainRequest) (*SayHelloAgainResponse, error) {
...
func _TestService_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SayHelloAgainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServiceServer).SayHelloAgain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TestService_SayHelloAgain_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).SayHelloAgain(ctx, req.(*SayHelloAgainRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TestService_SayHelloAgain_Handler,
		},
	},
